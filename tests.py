...
class SpotifyTestCase(unittest.TestCase):
    ...
    def test_artis_lookupt(self):
        ...
        self.assertEquals('» The Naked And Famous » spotify:artist:0oeUpvxWsC8bWS6SnpU8b9', resp)

    def test_album_lookupm(self):
        ...
        self.assertEquals('» Strobelight [The Morning After] » spotify:album:6QdPTJl9FwijKElfxhVf40', resp)
    ...
    def test_track_lookup(self):
        ...
        self.assertEquals('» Babian - Kärlek I Paket [Kärlek I Paket - Single] (03:38) » spotify:track:72tmEm4EzNBf38Rv883Mth', resp)
